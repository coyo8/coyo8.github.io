...
and now I can feel the difference in my life. I haven't become the next [Elon Musk](https://en.wikipedia.org/wiki/Elon_Musk){:target="_blank"} or [Stephen Hawking](https://en.wikipedia.org/wiki/Stephen_Hawking){:target="_blank"} but for surely it has paved the way for inner greatness and satisfaction.

The title says "Rick".

> Who is Rick?

Rick is a main character in [Rick and Morty](https://en.wikipedia.org/wiki/Rick_and_Morty){:target="_blank"}  American animated science fiction comedy created by [Justin Roiland](https://en.wikipedia.org/wiki/Justin_Roiland){:target="_blank"} and [Dan Harmon](https://en.wikipedia.org/wiki/Dan_Harmon){:target="_blank"} for [Adult Swim](https://en.wikipedia.org/wiki/Adult_Swim){:target="_blank"}. He is a scientist and at first it seems, he doesn't care about anything.
...
After having a glimpse of the above portrait, you can get an overlay imagination of Rick's personality. Let's quickly move to the moot point of the post i.e. To understand why Rick doesn't give a fuck? I am trying to reverse engineer a human character and literally it takes years to imbibe in oneself. To get started, We will first need to learn a bit about Rick's personality, ambition and goal which will help us to simulate our life situations with his.
...
Sounds like bad characters to have in lieu with the current pseudo-conservative society. I agree with you. We don't need to be alcoholic to be carefree or considered other fellow being inferiors to us. *The fight is fucking with ourselves, fucking our own inner self.* Which is inside you, me and any human being. It has tamed in a cage of the worldly illusion of prosperity by sacrificing who you truly are. Here comes the first lesson.
...
We need to appreciate these people in life instead of having prejudiced.
...
Now several tasks can make up an event and as human being, we remember only events. Your birthday is an event where you might have done several tasks like Getting dressed, call each friend, ordering cake etc. The idea is to break the task into as smaller subset as you can.

I will be giving my example of an event which has become an annoyance over the time. ***In Person Meeting With People*** due to several reasons. First, go through various tasks need to perform:
...
Now bring out the all the things which can turn bad and can lead to a certain output.
...
Every task has their own output as issues, traffic can delay your meeting time, You can't find cabs/buses, Your clothes are not ironed, so many things can happen and this will hit your emotional nerve. For me traveling in Bangalore traffic and then waiting for hours on the way is a nightmare. In simple maths terms, there are a lot of variables with dependency on outputs (Long waiting for hours in traffic(variable) can delay in meeting(output)). The key to controlling your environment lies in: How can we achieve certainty over these variables and output dependency?

*** Even the most chaotic life have pattern ***

The idea is to analyze tasks which have maximum dependency with your output (many-to-one)
...
If a task has greater dependency, I will try ways to solve it first. Most of the time mismatch in reaching time happens because I do not have a proper reminder for it and you can see in above table. I started having reminders on my calendar with 15, 10, 5 minutes before notifications alerts. These have helped me reduced all the next subsequent problems. Looking for these small nitty gritty is the key and then trying to solve with the resources within your hand will help to have greater control over the environment.


Throughout the show, you will find Rick have a way to get through almost any situation but panicking hell out of his grandson Morty. I think it's because with his knowledge and experience, he had made his dependency graph almost perfect and he is well aware of the outcome of the tasks as well as risk involved in each of it and that is his secret of carefree confidence but in one episode i.e. ---Schrodinger cat--- he left out with no choice but to pray god to save his life.


So, no one is perfect and there may be a deviation from what you are expecting as the outcome but sooner or later if you have done meticulous research for the situation you will get through with better confidence by solving each smaller task. Here I will stop this lesson because you might have already heard thousands of rants by successful people from here.
